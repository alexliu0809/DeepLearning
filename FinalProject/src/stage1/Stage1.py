...
#Round1
#Number of Epochs: 36
#Range of Eta: 0.0001 - 10

pair_numbers = 36
number_of_epoch = 1
np.random.seed(0)
for i in range(pair_numbers):
    eta = 10 ** np.random.uniform(-4,1) #0.0001 - 10
    ...
    #Test
    #NormalSGD(0.5, number_of_epoch)
    #MyRMSProp(0.5, 0.9, number_of_epoch)
    #MyAdam(0.5, 0.9, 0.999, number_of_epoch)
...
np.random.seed(1)
for i in range(pair_numbers):
    eta = 10 ** np.random.uniform(0,1) #1 - 10
    g_RMSProp = 1 - 10 ** np.random.uniform(-0.8,-2) #0.84 - 0.99
    beta1_Adam = 1 - 10 ** np.random.uniform(-0.8,-3) #0.84 - 0.999
    beta2_Adam = 1 - 10 ** np.random.uniform(-0.8,-4) #0.84 - 0.9999
